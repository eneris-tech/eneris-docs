import ImageTemplates1 from './img/templates-1.webp';
import ImageTemplates2 from './img/templates-2.webp';
import ImageTemplates3 from './img/templates-3.webp';
import ImageTemplates4 from './img/templates-4.webp';
import ImageTemplates5 from './img/templates-5.webp';
import ImageTemplates6 from './img/templates-6.webp';
import ImageTemplates7 from './img/templates-7.webp';
import ImageTemplates8 from './img/templates-8.webp';
...
<img src={ImageTemplates1} style={{ maxWidth: '600px', width: '100%' }} alt="Overview of templates page" />
...
<img src={ImageTemplates2} style={{ maxWidth: '600px', width: '100%' }} alt="View/Edit button for templates" />

2. Select the system that needs an additional item. e.g., **Electrical**.

<img src={ImageTemplates3} style={{ maxWidth: '600px', width: '100%' }} alt="Select system for editing in the template" />
...
<img src={ImageTemplates4} style={{ maxWidth: '600px', width: '100%' }} alt="Add an item to a system in the template" />
...
<img src={ImageTemplates5} style={{ maxWidth: '600px', width: '100%' }} alt="Enter the required fields to create a new item" />

6. The newly created "Solar Panels" item inside the Electrical section is now seen at the bottom of the list.

<img src={ImageTemplates6} style={{ maxWidth: '600px', width: '100%' }} alt="Newly created item can be seen at the bottom of the list within the system" />
...
<img src={ImageTemplates7} style={{ maxWidth: '600px', width: '100%' }} alt="Edit/Remove button for templates" />
...
<img src={ImageTemplates8} style={{ maxWidth: '600px', width: '100%' }} alt="Rearrange items in the list within the system" />
