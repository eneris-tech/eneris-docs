...
<img src={ImageInspectionForms1} style={{ maxWidth: '250px', width: '100%' }} alt="Inspection form example." />

and when adding a new **Inspection Form** to an existing **Inspection**.

<img src={ImageInspectionForms2} style={{ maxWidth: '250px', width: '100%' }} alt="Inspection form selection." />
...
<img src={ImageInspectionForms6} style={{ maxWidth: '250px', width: '100%' }} alt="Primary photo example." />
...
<img src={ImageInspectionForms9} style={{ maxWidth: '250px', width: '100%' }} alt="Add new inspection categories." />
...
<img src={ImageInspectionForms12} style={{ maxWidth: '250px', width: '100%' }} alt="Inspection form sync options." />
...
<img src={ImageInspectionForms13} style={{ maxWidth: '250px', width: '100%' }} alt="Published report options." />
