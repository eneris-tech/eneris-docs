...
Quote line items are a frozen snapshot taken when the booking page is saved. Later edits to the underlying [**Pricing Items**](/docs/concepts/invoicing-and-pricing-items) do not propagate to existing booking pages.
...
- [**Invoicing and Pricing Items**](/docs/concepts/invoicing-and-pricing-items): quote line items and the Invoice created on Accept.
