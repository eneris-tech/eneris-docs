...
<img src={ImageCustomizingFormTemplates1} style={{ maxWidth: '800px', width: '100%' }} alt="Creating new categories in a Form Template." />
...
<img src={ImageCustomizingFormTemplates2} style={{ maxWidth: '800px', width: '100%' }} alt="Editing categories in a Form Template." />
...
<img src={ImageCustomizingFormTemplates3} style={{ maxWidth: '800px', width: '100%' }} alt="Deleting categories in a Form Template." />
...
<img src={ImageCustomizingFormTemplates4} style={{ maxWidth: '800px', width: '100%' }} alt="Creating new components in a Form Template." />
...
<img src={ImageCustomizingFormTemplates5} style={{ maxWidth: '800px', width: '100%' }} alt="Editing components in a Form Template." />
...
<img src={ImageCustomizingFormTemplates6} style={{ maxWidth: '800px', width: '100%' }} alt="Deleting components in a Form Template." />
...
<img src={ImageCustomizingFormTemplates7} style={{ maxWidth: '800px', width: '100%' }} alt="Creating new fields in a Form Template." />
...
<img src={ImageCustomizingFormTemplates8} style={{ maxWidth: '800px', width: '100%' }} alt="Editing fields in a Form Template." />
...
<img src={ImageCustomizingFormTemplates9} style={{ maxWidth: '800px', width: '100%' }} alt="Deleting fields in a Form Template." />
...
The `Status`, `Condition`, `Recommended Action`, and `Summary Label` fields cannot be deleted. They can only be [hidden](/docs/concepts/customizing-form-templates#field-visibility) in the [report](/docs/concepts/reports).
...
<img src={ImageCustomizingFormTemplates10} style={{ maxWidth: '800px', width: '100%' }} alt="Creating new field options in a Form Template." />
...
<img src={ImageCustomizingFormTemplates11} style={{ maxWidth: '800px', width: '100%' }} alt="Editing field options in a Form Template." />
...
<Tabs>
  <TabItem value="Checkbox" label="Checkbox" default>
    ...
    <img src={ImageCustomizingFormTemplates12} style={{ maxWidth: '800px', width: '100%' }} alt="Deleting checkbox options in a Form Template." />
  ...
  <TabItem value="Choice" label="Choice">
    ...
    <img src={ImageCustomizingFormTemplates13} style={{ maxWidth: '800px', width: '100%' }} alt="Deleting choice options in a Form Template." />
  ...
  <TabItem value="Text" label="Text">
    ...
    <img src={ImageCustomizingFormTemplates14} style={{ maxWidth: '800px', width: '100%' }} alt="Deleting text field options in a Form Template." />
  ...
  <TabItem value="Multi-line text" label="Multi-line text">
    ...
    <img src={ImageCustomizingFormTemplates15} style={{ maxWidth: '800px', width: '100%' }} alt="Deleting multi-line text field options in a Form Template." />
...
<img src={ImageCustomizingFormTemplates16} style={{ maxWidth: '800px', width: '100%' }} alt="Category limitations tab in a Form Template." />
...
<img src={ImageCustomizingFormTemplates17} style={{ maxWidth: '800px', width: '100%' }} alt="Category disclaimer tab in a Form Template." />
