...
<img src={ImageServiceAgreements1} style={{ maxWidth: '800px', width: '100%' }} alt="Service Agreement Templates menu in sidebar." />

You will see a list of all available Service Agreement Templates, including any templates you have created.

<img src={ImageServiceAgreements2} style={{ maxWidth: '800px', width: '100%' }} alt="List of Service Agreement Templates." />
...
<img src={ImageServiceAgreements3} style={{ maxWidth: '800px', width: '100%' }} alt="Create new Service Agreement Template." />
...
<img src={ImageServiceAgreements4} style={{ maxWidth: '800px', width: '100%' }} alt="Edit a Service Agreement Template." />
...
<img src={ImageServiceAgreements5} style={{ maxWidth: '800px', width: '100%' }} alt="Linking a Service Agreement Template to a Form Template." />
