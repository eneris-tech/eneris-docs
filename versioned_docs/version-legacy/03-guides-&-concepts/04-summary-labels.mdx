import ImageSummaryLabels1 from './img/summary-labels-1.webp';
import ImageSummaryLabels2 from './img/summary-labels-2.webp';
import ImageSummaryLabels3 from './img/summary-labels-3.webp';
import ImageSummaryLabels4 from './img/summary-labels-4.webp';
...
<img src={ImageSummaryLabels1} style={{ maxWidth: '600px', width: '100%' }} alt="The location of summary labels when writing a report" />
...
<img src={ImageSummaryLabels2} style={{ maxWidth: '600px', width: '100%' }} alt="Where the selected summary labels show up in the PDF report table of contents" />
...
<img src={ImageSummaryLabels3} style={{ maxWidth: '600px', width: '100%' }} alt="Where the selected summary labels show up in the web report" />
...
<img src={ImageSummaryLabels4} style={{ maxWidth: '800px', width: '100%' }} alt="Customize summary labels in the settings menu" />