...
*This section will cover how to enter data into your inspection reports. `Templates` make this process even simpler and you can find additional information about templates [here](/docs/legacy/guides-&-concepts/templates).*
