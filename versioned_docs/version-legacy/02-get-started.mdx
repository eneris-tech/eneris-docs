...
export function TemplateLink() {
  ...
  const { isElevateEnabled } = siteConfig.customFields;

  const link = isElevateEnabled
    ? '/docs/legacy/guides-&-concepts/templates'
    : '/docs/guides-&-concepts/templates';
...
*This section will cover how to enter data into your inspection reports. `Templates` make this process even simpler and you can find additional information about templates <TemplateLink />.*
